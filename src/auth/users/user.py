...
class User:
    def __init__(self, user_type, provider_type, verified, firstName, lastName, email, phone_number=None, other_data=None):
    ...
    def validate(email: str) -> bool:
        ...
        try:
            ...
            verification_certificate_jwt = user_doc_ref.get().to_dict().get('verification_certificate_jwt')
        ...
        try:
            jwt.decode(verification_certificate_jwt, jwt_key, algorithms=['HS256'])
